  ...
  const phases = [
    {
      ...
      desc: "All registered participants enter the floor. Dancers are randomly paired and rotate frequently to ensure a fair assessment across different partners and musical styles. It's the YES or NO phase, where judges quickly evaluate connection, timing, and musicality to determine who advances.",
      leaders: "40",
      followers: "40",
      songs: "7",
      switches: "3",
